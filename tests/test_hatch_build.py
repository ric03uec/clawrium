...
class TestInitialize:
    ...
    @pytest.fixture()
    def _hook(self, monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> MagicMock:
    ...
    def test_writes_valid_python(self, _hook: MagicMock, tmp_path: Path) -> None:
    ...
    def test_preserves_existing_sha(self, _hook: MagicMock, tmp_path: Path) -> None:
    ...
    def test_overwrites_unknown_sha(self, _hook: MagicMock, tmp_path: Path) -> None:
