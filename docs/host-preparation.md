...
> **Applying a static IP over SSH drops your session** the moment the
> address changes. Run these commands from a local console where you can,
> and reconnect on the new address.
