...
```bash
$ clawctl agent create oc-default-mybox --type openclaw --host mybox --provider anthropic
...
oc-default-mybox   openclaw   mybox   anthropic   running   2m    nemoclaw@v0.0.97
```
