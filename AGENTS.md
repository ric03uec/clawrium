...
| Zeroclaw Slack MCP (`slack-user`, `slack-cookie`) | `zeroclaw/playbooks/install_slack_mcp.yaml` (Linux-only; macOS deferred) | `_zeroclaw_install_slack_mcp` (lifecycle_canonical.py, #836) |
